...
class InstagramScraper(BaseScraper):
    ...
    def scrape_user(self, user):
        ...
        user_folder = os.path.join(WORKING_DIR, "instagram", user)
...
class ThreadsScraper(BaseScraper):
    ...
    def scrape_user(self, user):
        ...
        user_folder = os.path.join(WORKING_DIR, "threads", user)
        os.makedirs(user_folder, exist_ok=True)
...
class FacebookScraper(BaseScraper):
    ...
    def scrape_user(self, user):
        ...
        user_folder = os.path.join(WORKING_DIR, "facebook", user)
        os.makedirs(user_folder, exist_ok=True)
    ...
    def _extract_info_nodes_in_html(self, user):
        ...
        for fbid_link in fbid_links:
            if fbid_link not in [result[1] for result in results]:
